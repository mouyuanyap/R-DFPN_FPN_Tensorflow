    ...
    with tf.Graph().as_default():
        ...
        with tf.Session(config=config) as sess:
            ...
            for img_path in file_paths:
                ...
                w = open("/content/drive/MyDrive/RDFPN_ckpt1/result_final/annotations/{}.txt".format(img_path.split('/')[-1].split('.')[0]), "w")
                ...
                for hh in range(0, imgH, h_len):
                    ...
                    for ww in range(0, imgW, w_len):
                        ...
                        cv2.imwrite('/content/drive/MyDrive/RDFPN_ckpt1/result_final/rpn' + '/ship{}_fpn.jpg'.format(p), rpn_image[0])
                ...
                cv2.imwrite('/content/drive/MyDrive/RDFPN_ckpt1/result_final/output' + '/ship{}_fpn.jpg'.format(p), img_np)
                p = p + 1
