...
# root path
ROOT_PATH = os.path.abspath(r'/content/R-DFPN_FPN_Tensorflow')
...
ANCHOR_SCALES = [1.]
ANCHOR_RATIOS = [1.,1/2.,2.,1/5., 5., 1/7., 7., 1/9, 9]
...
BATCH_SIZE = 1
WEIGHT_DECAY = {'resnet_v1_50': 0.0001, 'resnet_v1_101': 0.005}
EPSILON = 1e-5
MOMENTUM = 0.94
MAX_ITERATION = 80000
LR = 0.005
...
RPN_TOP_K_NMS = 8000
RPN_ANCHOR_ANGLES_THRESHOLD = 11.0
RPN_NMS_ANGLES_THRESHOLD = 11.0
KERNEL_SIZE = 5
...
FAST_RCNN_NMS_MAX_BOXES_PER_CLASS = 50
...
FAST_RCNN_USE_ANGLE_CONDITION = True
USE_MASK = False
